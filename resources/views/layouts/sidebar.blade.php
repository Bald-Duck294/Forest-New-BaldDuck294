<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-content py-2">
        ...
        <a href="/home" class="sidebar-link {{ request()->is('home') ? 'active' : '' }}" title="Old Dashboard">
            <i class="bi bi-archive fs-5 me-2"></i>
            <span class="link-text">Dashboard</span>
        </a>

        <a href="/analytics/executive" class="sidebar-link {{ request()->is('analytics/executive') ? 'active' : '' }}"
        ...
        {{-- 1. Foot Patrolling --}}
        <a href="/patrol/foot-summary" class="sidebar-link {{ request()->is('patrol/foot-summary') ? 'active' : '' }}"
        ...
        {{-- 2. Night Patrolling --}}
        <a href="/patrol/night-summary" class="sidebar-link {{ request()->is('patrol/night-summary') ? 'active' : '' }}"
        ...
        {{-- 3. KML/Patrol Map --}}
        <a href="/patrol/maps" class="sidebar-link {{ request()->is('patrol/maps') ? 'active' : '' }}"
        ...
        <a href="/attendance/summary" class="sidebar-link {{ request()->is('attendance/summary') ? 'active' : '' }}"
        ...
        {{-- 5. Incident Summary --}}
        <a href="/incidents/summary" class="sidebar-link {{ request()->is('incidents/summary') ? 'active' : '' }}"
        ...
        <a href="{{ route('sites.getsites', 0) }}" class="sidebar-link {{ request()->routeIs('sites*') ? 'active' : '' }}">
        ...
        {{-- Grid Management --}}
        <a href="/plantation/grids" class="sidebar-link {{ request()->is('plantation/grids') ? 'active' : '' }}"
        ...
        {{-- User Roles --}}
        <a href="/plantation/users" class="sidebar-link {{ request()->is('plantation/users') ? 'active' : '' }}"
            title="User Roles">
