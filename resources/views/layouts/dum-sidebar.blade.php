    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-item">
            ...
            <a class="sidebar-link d-flex align-items-center justify-content-between" data-bs-toggle="collapse"
                href="#attendanceMenu" role="button"
        ...
        <a href="{{ route('beat_features.dashboard') }}"
            class="sidebar-link {{ request()->is('forest/beat-features*') ? 'active' : '' }}" title="Beat Features">
            <i class="bi bi-pin-map"></i>
            <span class="link-text">Beat Features</span>
        </a>
        <a href="{{ route('events.reports.dashboard') }}"
            class="sidebar-link {{ request()->is('events/reports-dashboard*') ? 'active' : '' }}" title="Events">
