...
@section('title', get_label('label_attendance', 'Attendance') . ' ' . get_label('label_logs', 'Logs'))
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label small fw-semibold" style="color: var(--text-muted);">
                        {{ get_label('label_user', 'Employee') }}
                    </label>
                    <select class="form-select custom-select-input w-100" name="employee">
                        <option value="">All {{ Str::plural(get_label('label_user', 'Employees')) }}</option>
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select custom-select-input w-100" name="site">
                        <option value="">All {{ Str::plural(get_label('label_site', 'Sites')) }}</option>
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select custom-select-input w-100" name="client">
                        <option value="">All {{ Str::plural(get_label('label_client', 'Clients')) }}</option>
    ...
    <div class="dash-card p-0 overflow-hidden">
        ...
        <div class="table-responsive">
            <table class="table table-borderless dash-table mb-0 align-middle">
                <thead>
                    <tr>
                        <th class="ps-4">{{ get_label('label_user', 'User') }} Name</th>
                        <th>{{ get_label('label_site', 'Site') }} Name</th>
                        <th>Duration</th>
                        <th>Status</th>
