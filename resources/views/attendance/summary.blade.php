...
@section('content')
            ...
            <div class="card border-0 shadow-sm h-100 kpi-card">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="rounded-circle d-flex align-items-center justify-content-center kpi-icon-wrapper"
            ...
            <div class="card border-0 shadow-sm h-100 kpi-card">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="rounded-circle d-flex align-items-center justify-content-center kpi-icon-wrapper"
                            style="width: 40px; height: 40px; background: rgba(25, 135, 84, 0.1); color: #198754;">
            ...
            <div class="card border-0 shadow-sm h-100 kpi-card">
                <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="rounded-circle d-flex align-items-center justify-content-center kpi-icon-wrapper"
                            style="width: 40px; height: 40px; background: rgba(255, 193, 7, 0.1); color: #ffc107;">
                    ...
                    <div class="dot-table-scroll">
                        <table class="dot-table sortable-table">
                                ...
                                <tr>
                                    ...
                                    @foreach ($dates as $dt)
                                        <th title="{{ $dt->format('Y-m-d') }}">
                                            {{ $dt->format('d') }}<br>
                                            <small
                                                style="font-size:9px; font-weight:400; color:#888;">{{ $dt->format('M') }}</small>
                                        </th>
                                    @endforeach
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="user-cell" style="background: #fff;">
                                            <img src="{{ asset($user->profile_pic ?? 'images/user-placeholder.png') }}"
                                                class="user-avatar">
                                            <a href="#" class="guard-name-link user-name text-decoration-none"
                                                data-guard-id="{{ $user->id }}">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="{{ count($dates) + 5 }}" class="text-center py-5 text-muted">No
                                            attendance records found for this period.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-lg-8">
            <div class="card chart-box h-100">
                <h6 class="fw-bold mb-3">
                    Daily Attendance
                    <small class="text-muted fw-normal ms-2" style="font-size: 0.75rem;">(Click bars to view guard
                        list)</small>
                </h6>
                        ...
                        <tbody>
                            @forelse($defaulters as $d)
                                <tr>
                                    ...
                                    <td><a href="#" class="guard-name-link user-name text-decoration-none"
                                            data-guard-id="{{ $d['user_id'] }}">
                                            {{ \App\Helpers\FormatHelper::formatName($d['name']) }}
                                        </a></td>
                                    <td class="text-end fw-bold" style="color:rgb(250, 123, 129);">{{ $d['days_absent'] }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
    ...
    <style>
        ...
        .dot-table-scroll {
            ...
            background: #ffffff;
            -webkit-overflow-scrolling: touch;
            /* Vital for mobile momentum */
        }

        /* Custom scrollbar for better appearance */
        .dot-table-scroll::-webkit-scrollbar {
            width: 6px;
            height: 6px;
        }

        .dot-table-scroll::-webkit-scrollbar-thumb {
            background: #cbd5e0;
            border-radius: 10px;
        }
        ...
        .dot-table td:first-child {
            ...
            z-index: 20;
            /* Keep it above normal scrolling content */
            width: 60px;
            min-width: 60px;
            text-align: center;
        ...
        @media (max-width: 768px) {
            ...
            .dot-table th:nth-child(4),
            .dot-table td:nth-child(4),
            /* Range/Beat */
