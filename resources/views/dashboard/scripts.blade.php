            ...
            views: {
...

                    {
                        ...
                        generator: (idx, db) => {
                            ...
                            return {
                                ...
                                datasets: [{
                                    data: v,
                                    backgroundColor: l[0] === 'No Data' ? [CHART_COLORS.slate] : COLOR_PALETTE
                                }]
                            };
                        },
                        options: {
                ...
                'events.compensation': [{
                        ...
                        calcPill: (data, idx) => idx === 1 ?
                            `Total: ₹${(data.datasets[0].data.reduce((a, b) => a + b, 0) / 1000).toFixed(1)}k` : `Total: ${data.datasets[0].data.reduce((a, b) => a + b, 0)}`
                    },
                    {
                        id: 'comp-c2',
                        ...
                        generator: (idx, db) => {
                            ...
                            return {
                                ...
                                datasets: [{
                                    ...
                                    backgroundColor: idx === 0 ? 'rgba(239,68,68,0.1)' : 'rgba(245,158,11,0.1)',
                                    fill: true,
                                    tension: 0.4
                                }]
                            };
