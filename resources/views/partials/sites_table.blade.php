...
<div class="table-responsive">
            ...
            <tr>
                ...
                <th>
                    <a href="javascript:void(0)" onclick="handleSort('name')"
                        ...
                        {{-- Pulls "Beat" if overridden, otherwise "Site" --}}
                        {{ get_label('label_site', 'Site') }} Name
    ...
    {{-- Dynamic Label for Client (e.g., Range) --}}
    {{ get_label('label_client', 'Client') }}

    <i class="bi {{ request('sort') == 'client' ? (request('dir') == 'asc' ? 'bi-sort-up' : 'bi-sort-down') : 'bi-arrow-down-up' }}"></i>
</a>
                </th>
