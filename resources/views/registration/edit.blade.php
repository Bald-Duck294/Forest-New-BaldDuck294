            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <p>Update the registration details for this user.</p>
                    </div>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('registrations.update', $registration->id) }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstName" id="firstName" class="form-control"
                                        placeholder="e.g. John" value="{{ old('firstName', $registration->firstName) }}"
                                        required>
                                    @error('firstName')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lastName" id="lastName" class="form-control"
                                        placeholder="e.g. Doe" value="{{ old('lastName', $registration->lastName) }}">
                                    @error('lastName')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile" id="mobile" class="form-control numeric-only"
                                        ...
                                        value="{{ old('mobile', $registration->mobile) }}" maxlength="10"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control"
                                        placeholder="name@company.com" value="{{ old('email', $registration->email) }}">
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation" id="designation" class="form-control"
                                        ...
                                        value="{{ old('designation', $registration->designation) }}">
                                    @error('designation')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="role_id" id="role_id" class="form-control" required>
                                        <option value="" disabled>-- Select Member Role --</option>
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->id }}"
                                                {{ old('role_id', $registration->role_id) == $role->id ? 'selected' : '' }}>
                                                {{ $role->role_name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="registrationFlag">Registration Status <span
                                            class="required-asterisk">*</span></label>
                                    <select name="registrationFlag" id="registrationFlag" class="form-control" required>
                                        <option value="0"
                                            {{ old('registrationFlag', $registration->registrationFlag) == 0 ? 'selected' : '' }}>
                                            Pending</option>
                                        <option value="1"
                                            {{ old('registrationFlag', $registration->registrationFlag) == 1 ? 'selected' : '' }}>
                                            Registered</option>
                                    </select>
                                    @error('registrationFlag')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn-primary-action">
                                <i class="la la-check"></i> Update Member
                            </button>
                        </div>
