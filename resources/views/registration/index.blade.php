...
@extends('layouts.app')
@section('title', get_label('label_registration', 'Registration'))
@section('content')
<style>
...
<div class="custom-theme-wrapper">
    ...
    @if (session('success'))
    <div class="alert alert-success alert-dismissible fade show mt-3 mb-0 d-flex align-items-center" role="alert" style="border-radius: 12px;">
