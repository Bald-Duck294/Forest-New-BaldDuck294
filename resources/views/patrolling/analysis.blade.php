            ...
            <div class="row g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="d-flex flex-column flex-md-row gap-3">
                        <div class="map-stat-block shadow-sm">
                            <small class="text-uppercase fw-bold"
                                style="color: var(--text-muted); font-size: 0.75rem;">Total Distance</small>
                            <h4 class="fw-bold mb-0 mt-1" style="color: var(--sapphire-primary);" id="clientDistance">0 km
                            </h4>
                        </div>
    ...
    <script>
        ...
        @if (count($sessions) > 0)
            ...
            function drawSessions() {
                ...
                document.getElementById('clientDistance').innerText = totalClientDistance.toFixed(2) + ' km';
            }
