        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                window.deleteClient = function(id) {
                    var msg =
                        'Are you sure you want to delete this {{ strtolower(get_label('label_client', 'client')) }}?';
                ...
                window.toggleActive = function(id, element, currentlyActive) {
                    ...
                    var msg =
                        `Are you sure you want to ${action} this {{ strtolower(get_label('label_client', 'client')) }}?`;
                    ...
                    if (typeof Swal !== 'undefined') {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                var url = currentlyActive ? '{{ route('clients.inactive', ':id') }}' :
